...
void Start()
     ...
     // Calculate the journey length.
          journeyLength = Vector2.Distance(startMarker4.position, endMarker4.position);
     }
...
void Update()
     ...
     // Set our position as a fraction of the distance between the markers and pingpong the movement.
          transform.position = Vector2.Lerp(startMarker4.position, endMarker4.position, Mathf.PingPong (fracJourney, 1));
     }
}
